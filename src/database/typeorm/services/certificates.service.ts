...
import {
    ...
    CertificatesUpdateModel } from '../../../domain.types/certificates.types';
...
export class CertificatesService extends BaseService {
    ...
    public create = async (createModel: CertificatesCreateModel)
        : Promise<CertificatesResponseDto> => {
...
IssuedBy : createModel.IssuedBy,
    ...
    public search = async (filters: CertificatesSearchFilters)
        : Promise<CertificatesSearchResults> => {
        try {
    ...
    public update = async (id: uuid, model: CertificatesUpdateModel)
        : Promise<CertificatesResponseDto> => {
        try {
