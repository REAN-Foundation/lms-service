...
export class LearningPathCoursesService extends BaseService {
    ...
    public create = async (createModel: LearningPathCoursesCreateModel): Promise<LearningPathCoursesResponseDto> => {
    ...
    public search = async (filters: LearningPathCoursesSearchFilters): Promise<LearningPathCoursesSearchResults> => {
        try {
    ...
    public update = async (
        id: uuid,
        model: LearningPathCoursesUpdateModel
