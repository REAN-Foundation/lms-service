...
//     const authenticate = async (request: express.Request): Promise<AuthenticationResult> => {
//         try {
...
//     const isPublicResourceDownloadRequest = async (request: express.Request): Promise<boolean> => {
//         const requestUrl = request.originalUrl;
